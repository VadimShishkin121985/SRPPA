...
class LocatorsPage():
    ...
    POINT_ON_MAP = "#dot"
    CONTAINER_NUMBER_POINT = ".Popup__header"
    ...
    VESSEL_TRACKING_APP = "//div[@class='dropMenu__content js-drop-content']//p[@class='dropMenu__title'][normalize-space()='Vessel Tracking']"
    INPUT_VESSEL_TRACKING = "[data-test-id='vt-search-input']"
    SEARCH_VESSEL_TRACKING = "[data-test-id='vt-search-button']"
    SUBSCRIPTION_VT_BUTTON = "[data-test-id='vt-payments-subscription-button']"
    CREDITS_USED_VESSEL_TRACKING = "[data-test-id='vt-payments-data-credits-used']"
    COPY_LINK_VESSEL_TRACKING = "button.vessel-tracking-WTsBDL:not([data-test-id])"
    SCHEDULE_TAB_VESSEL_TRACKING = "[data-test-id='vt-openedCard-schedule-tab']"
