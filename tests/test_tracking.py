...
class Test_Tracking:
    ...
    def test_go_to_ct_from_filter_303169537(self, page):
        ...
        sleep(2)
        assert page.wait_for_selector(".app-root-unified_tracking", state="visible", timeout=10000)

    def test_the_update_button_in_the_list_264863760(self, page):
        self.test_go_to_ct_app(self.page)
        self.container_tracking_page.update_button_click()

    def test_saving_number_265191426(self, page):
        self.test_go_to_ct_app(self.page)
